<?php $__env->startSection('title', 'หน้ารายละเอียด'); ?>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            confirmButton.addEventListener('click', function(event) {
                ...
                if (Object.keys(orderData).length > 0) {
                    $.ajax({
                        type: "post",
                        url: "<?php echo e(route('SendOrder')); ?>",
                        data: {
                            orderData: orderData,
                            remark: $('#remark').val()
                        },
...
<?php echo $__env->make('layouts.luxury-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop-app\resources\views/users/list_page.blade.php ENDPATH**/ ?>