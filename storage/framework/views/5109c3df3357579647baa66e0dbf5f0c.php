    ...
    $(document).on('click', '.deleteCategory', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(route('CategoryDelete')); ?>",
                    type: "post",
                    data: {
                        id: id
                    },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop-app\resources\views/category/index.blade.php ENDPATH**/ ?>