            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-end">
                        <a href="<?php echo e(route('tableCreate')); ?>" class="btn btn-sm btn-outline-success d-flex align-items-center" style="font-size:14px">เพิ่มโต้ะ&nbsp;<i class="bx bxs-plus-circle"></i></a>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    $(document).ready(function() {
        $("#myTable").DataTable({
            ...
            processing: true,
            ajax: {
                url: "<?php echo e(route('tablelistData')); ?>",
                type: "post",
                headers: {
    ...
    $(document).on('click', '.deleteTable', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(route('tableDelete')); ?>",
                    type: "post",
                    data: {
                        id: id
                    },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop-app\resources\views/table/index.blade.php ENDPATH**/ ?>