...
<head>
    <meta charset="UTF-8">
    <title><?php echo $__env->yieldContent('title', 'So Fin'); ?></title>
    ...
    <style>
        ...
        @font-face {
            font-family: 'PROMPT';
            src: url('<?php echo e(asset("fonts/PROMPT-LIGHT.TTF")); ?>') format('truetype');
            font-weight: normal;
        }

        @font-face {
            font-family: 'PROMPT';
            src: url('<?php echo e(asset("fonts/PROMPT-SEMIBOLD.TTF")); ?>') format('truetype');
            font-weight: bold;
        }
        ...
        body {
            ...
            background-image: url('<?php echo e($config->image_bg ? url("storage/".$config->image_bg) : asset("bg-df/bg-dfs.jpg")); ?>');
...
</html><?php /**PATH C:\xampp\htdocs\shop-app\resources\views/layouts/luxury-nav.blade.php ENDPATH**/ ?>