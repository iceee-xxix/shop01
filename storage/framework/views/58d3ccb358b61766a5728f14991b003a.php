                    ...
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2"><?php echo e($orderday->total); ?> บาท</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php echo e(asset('assets/img/icons/unicons/chart-success.png')); ?>" alt="Credit Card" class="rounded" />
                                    </div>
                                </div>
                                <span class="fw-semibold d-block mb-1">ยอดขายเดือนนี้</span>
                                <h3 class="card-title mb-2"><?php echo e($ordermouth->total); ?> บาท</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2"><?php echo e($orderyear->total); ?> บาท</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2"><?php echo e($ordertotal); ?> รายการ</h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        $("#myTable").DataTable({
            ...
            ajax: {
                url: "<?php echo e(route('ListOrder')); ?>",
                type: "post",
                headers: {
...
<script>
    $(document).on('click', '.modalShow', function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo e(route('listOrderDetail')); ?>",
            data: {
                id: id
            },
            headers: {
    ...
    $(document).on('click', '.modalPay', function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo e(route('generateQr')); ?>",
            data: {
                total: total
            },
            headers: {
...
<script>
    ...
    $('#confirm_pay').click(function(e) {
        ...
        var id = $('#order_id').val();
        $.ajax({
            url: "<?php echo e(route('confirm_pay')); ?>",
            type: "post",
            data: {
                id: id
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop-app\resources\views/dashboard.blade.php ENDPATH**/ ?>