...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item <?php echo e(($function_key == 'dashboard') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(($function_key == 'promotion') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('promotion')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bxs-megaphone"></i>
                <div data-i18n="Analytics">โปรโมชั่น</div>
            </a>
        </li>
        <li class="menu-item <?php echo e(($function_key == 'table') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('table')); ?>" class="menu-link">
        ...
        <li class="menu-item <?php echo e(($function_key == 'category') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('category')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">หมวดหมู่</div>
            </a>
        </li>
        <li class="menu-item <?php echo e(($function_key == 'menu') ? 'active' : ''); ?>">
...
</aside><?php /**PATH C:\xampp\htdocs\shop-app\resources\views/admin/menu.blade.php ENDPATH**/ ?>